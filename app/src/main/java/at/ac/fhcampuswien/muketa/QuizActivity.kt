...
import at.ac.fhcampuswien.muketa.ui.theme.Purple200
import at.ac.fhcampuswien.muketa.ui.theme.Purple500
import at.ac.fhcampuswien.muketa.viewmodels.QuizViewModel
...
class QuizActivity : ComponentActivity() {
        ...
        setContent {
            MuKeTaTheme {
                ...
                Surface(
                    ...
                    val dataList = remember { mutableStateListOf<QuizModel>() }

                    quizViewModel.liveDataList.observe(this) {
                        if (it != null) {
                            if (it.size > 10) {
                                val rem = it.size - 10
    ...
    @Composable
    fun QuizLayout(list: List<QuizModel>) {
        ...
        if (button1Colors.size < list.size || button2Colors.size < list.size || button3Colors.size < list.size || button4Colors.size < list.size) {
            button1Colors.clear()
            button2Colors.clear()
            button3Colors.clear()
            button4Colors.clear()
